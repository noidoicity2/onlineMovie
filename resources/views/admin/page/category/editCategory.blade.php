    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12">
                        <form method="post" action="{{route("post_edit_category")}}">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" value="{{$category->slug}}" name="slug" id="slug" placeholder="Enter slug (optional)">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label for="inputAddressLine1">Description</label>
                                    <textarea name="description" value="" id="description" class="form-control" id="description" placeholder="Enter Description">{{$category->description}}</textarea>
                                </div>
